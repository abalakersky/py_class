...
def lambda_handler(event, context):
    ...
    print
    f'Found {len(instances):d} instances that need backing up'
    ...
    for instance in instances:
        try:
            ...
            if str(instance['InstanceId']) not in inDone:
                ...
                print
                f"We already got an AMI of instance {instance['InstanceId']} "
            ...
            print
            f"Retaining AMI {AMIid['ImageId']} of instance {instance['InstanceId']} for {retention_days:d} days"
